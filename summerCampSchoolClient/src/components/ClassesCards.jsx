        ...
        <div className='flex flex-col justify-between h-full'>
          ...
          <div className="card-body px-4 py-4">
            ...
            <div className="card-actions flex justify-between items-center">
              ...
              <button onClick={() => !user && navigate("/login", { state: { from: location } })} className={`btn bg-[#FFFFFF] hover:bg-[#A3A3F5] group-hover:bg-[#A3A3F5] text-[#101218] rounded-full px-2 lg:px-4 ${eachClass?.available_seats === eachClass?.student_enrolled || (userInfo?.role === 'instructor' || userInfo?.role === 'admin') && 'btn-disabled'}`}>Join Now
