...
const PopularInstructor = () => {
  ...
  return (
    <div className='lg:my-24'>
      ...
      <div className='lg:flex lg:justify-start lg:flex-wrap  lg:my-8 lg:mx-4 lg:gap-2 md:flex md:flex-row md:flex-wrap md:justify-start mt-4 mb-4'>
        {
          popularInstructors && popularInstructors?.length && Array?.isArray(popularInstructors) && popularInstructors?.map((instructor) => {
            ...
            return (
              <div key={instructor_id} className="card relative lg:mb-0 md:mb-3 sm:mb-3 mb-3">
                <img loading="lazy" className='rounded lg:w-[380px] md:w-96' src={instructor_image} alt="instructor_image" />
