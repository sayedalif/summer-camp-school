...
//     }
//     try {
//       const response = await axiosPublic.post('/users/save-user-data', { email, bio, phone, address, gender });
...
//     // Handle the file upload to your server or state management here
...
//           {/* name */}
//           <h1 className='mb-1 text-2xl'>{name}</h1>
//           {/* role */}
...
//           </div>
//           {
//             user && !user?.bio && !user?.address && !user?.phone && !user?.gender && <button className='btn bg-[#fca5a5] mt-3 outline-none border-0 px-7 py-4'
