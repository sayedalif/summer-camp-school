...
ami aber ajke '/payments?email=***' aie khane ami mistake korsi je ami pipeline ta create korar somoy ami 'classes_id' er moddhe data gula ke rakhsi array er moddhe oi ta ami fix kori nae then ami 'classes_id' ta payments collection er moddhe store korsi string er moddhe kintu oi ta ami ObjectId er moddhe convert kore nae jeno classes collection er moddhe '_id' ta r sathe match jae, aie problem tar moddhe ami age o porsilam.
 ...
 <!-- todo:
 1. amake payment er moddhe class er image and je sob details gula dorkar add korte hobe jeno ami payment route tar moddhe thake sob data delete korte per e user ke admin ban korar jonno.
 idea: arek ta kaj kora jae proti ta user payment info er moddhe banned class akta array of object create kore 

2. carts er moddhe ami classes_id gula ke array er moddhe set thik kortaci kintu proti ta indivisually so oi ta amake fix korte hobe.
  -->
